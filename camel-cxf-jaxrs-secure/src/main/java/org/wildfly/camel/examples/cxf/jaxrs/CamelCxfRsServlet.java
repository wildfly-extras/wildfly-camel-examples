...
@WebServlet(name = "HttpServiceServlet", urlPatterns = { "/cxf/*", "/example-camel-cxfrs-secure/cxf/*" }, loadOnStartup = 1)
public class CamelCxfRsServlet extends HttpServlet {

    @Resource(lookup = "java:jboss/camel/context/cxfrs-secure-camel-context")
