...
public class CxfRsExampleTest {
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.createFromZipFile(WebArchive.class, new File("target/examples/example-camel-cxf-jaxrs.war"));
    }

    @Test
    public void testSayHelloCxfRestRoute() throws Exception {
