...
@ServerSetup({SoapRestBridgeExampleTest.WeatherEndpointSetupTask.class})
public class SoapRestBridgeExampleTest {
    ...
    static class WeatherEndpointSetupTask implements ServerSetupTask {
        ...
        public void setup(ManagementClient managementClient, String s) throws Exception {
            ...
            endpoint = Endpoint.publish(JAXWS_URI_STS, implementor);
