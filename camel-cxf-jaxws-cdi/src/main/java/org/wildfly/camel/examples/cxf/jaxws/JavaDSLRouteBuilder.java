...
//	private CamelContext camelContext;
    ...
    public void configure() throws Exception {
    	...
    	CxfEndpoint cxfConsumerEndpoint = new CxfEndpoint("http://localhost:8080/webservices/greeting2", cxfConsumerComponent);
...
//    	cxfFromEndpoint.setDataFormat(DataFormat.PAYLOAD);
    	...
    	CxfEndpoint cxfProducerEndpoint = new CxfEndpoint("http://localhost:8080/webservices/greeting2", cxfProducerComponent);
